import { Product } from 'src/app/product-list/model/product.model';
...
export const PRODUCTS: Product[] = [
  {
    ...
    hashtags: ['aBrzKpykg9jzL62i4', 'dj5xTy5dcQ2WRiS9L', 'E5oZpTSjYnYfAQSiz'],
    isVisible: true,
    publishedAt: {
  ...
  },
  {
    ...
    ancestors: ['tftRbzc6Pic7NyCkg', 'fc6Waj38KdzRaKX4g'],
    type: 'variant',
    price: 24.99,
  ...
  },
  {
    ...
    ancestors: ['tftRbzc6Pic7NyCkg', 'MFQmGGPti9XBLNtiK'],
    type: 'variant',
    price: 24.99,
    inventoryManagement: true,
    inventoryPolicy: true,
  ...
  },
  {
    ...
    ancestors: ['tftRbzc6Pic7NyCkg', '2shvxg8QooaNFF9ZP'],
    type: 'variant',
    price: 24.99,
    inventoryManagement: true,
    inventoryPolicy: true,
  ...
  },
  {
    ...
    ancestors: ['tftRbzc6Pic7NyCkg', 'yBKSrMkWq3dN2C2sj'],
    type: 'variant',
    price: 24.99,
    inventoryManagement: true,
    inventoryPolicy: true,
  ...
  },
  {
    ...
    ancestors: ['LXECo6pZectbeHYEi', 'QvtZpk4mXBugKrZPb'],
    type: 'variant',
    price: 60.76,
    inventoryManagement: true,
    inventoryPolicy: true,
  ...
  },
  {
    ...
    ancestors: ['LXECo6pZectbeHYEi', '5yJvQgc2Q2efGce79'],
    type: 'variant',
    price: 60.76,
    inventoryManagement: true,
    inventoryPolicy: true,
  ...
  },
  {
    ...
    requiresShipping: true,
    hashtags: ['E5oZpTSjYnYfAQSiz', 'm2TtzXpNNgierdjKN', 'dg7X8xtzWDEBpENEL'],
    isVisible: true,
    workflow: {
      status: 'new',
    },
  ...
  },
  {
    ...
    ancestors: ['hPYwaFDX4dp9vocNY', 'PrtwGHct9jh8D3cyF'],
    type: 'variant',
    price: 89,
    inventoryManagement: true,
    inventoryPolicy: true,
  ...
  },
  {
    ...
    pageTitle: 'Nesciunt itaque modi soluta sint sint.',
    description:
      'The Vans Authentic is a time tested classic. This retro plimsoll is part of the Off The Wall range and is durable, responsive, and stylish with a lace up front and subtle branding on the outside. Finished off with the vulcanised Waffle sole',
    type: 'simple',
    vendor: 'Vans',
    price: {
      range: '89',
    ...
    requiresShipping: true,
    hashtags: ['m2TtzXpNNgierdjKN', 'jCCcuLd8hv437Zgha'],
    isVisible: true,
    workflow: {
      status: 'new',
    },
  ...
  },
  {
    ...
    ancestors: ['MGStoBoTZHNcSJrtf', 'mnAE7TDPKBdQvbTSK'],
    type: 'variant',
    price: 89,
    inventoryManagement: true,
    inventoryPolicy: true,
  ...
  },
  {
    ...
    requiresShipping: true,
    hashtags: ['tmqLnEa6d4ENgK3GQ', 'E5oZpTSjYnYfAQSiz', 'jNsL7cTTpk8rYPBqF'],
    isVisible: true,
    workflow: {
      status: 'new',
    },
  ...
  },
  {
    ...
    ancestors: ['xe3uaXSNzNZdQbyTP', 'pzt4cQYt2LgGJZDaC'],
    type: 'variant',
    price: 89,
    inventoryManagement: true,
    inventoryPolicy: true,
  ...
  },
  {
    ...
    requiresShipping: true,
    hashtags: ['tmqLnEa6d4ENgK3GQ', 'jNsL7cTTpk8rYPBqF'],
    isVisible: true,
    workflow: {
      status: 'new',
    },
  ...
  },
  {
    ...
    ancestors: ['SDtdoRMfhWv5yTrLH', 'GvZ7TX5ah4CJ2e55m'],
    type: 'variant',
    price: 89,
    inventoryManagement: true,
    inventoryPolicy: true,
  ...
  },
  {
    ...
    pageTitle: 'Nesciunt itaque modi soluta sint sint.',
    description:
      'Add some old-school cool to her look with this laid-back Airwalk sneaker. It features a quality canvas upper with laces for a good fit, a cushiony insole for comfort and a flexible, non-marking, built-up outsole. Fabric and rubber.',
    type: 'simple',
    vendor: 'Airwalk',
    price: {
      range: '14.99',
    ...
    requiresShipping: true,
    hashtags: ['979wmEwfQTgBJNgYj', 'E5oZpTSjYnYfAQSiz'],
    isVisible: true,
    workflow: {
      status: 'new',
    },
  ...
  },
  {
    ...
    ancestors: ['9Pa6qdfXa7y5pQBoY', '72Qomfd9SSzs3eRyE'],
    type: 'variant',
    price: 14.99,
    inventoryManagement: true,
    inventoryPolicy: true,
  ...
  },
  {
    ...
    pageTitle: 'Nesciunt itaque modi soluta sint sint.',
    description:
      "She'll be able to get her sparkle on with this fun take on the retro oxford from Liv and Maddie! It features a fabric upper, rubber cap toe laces, canvas lining, padded insole, and a built-up outsole. Manmade materials.",
    type: 'simple',
    ...
    requiresShipping: true,
    hashtags: ['979wmEwfQTgBJNgYj', 'E5oZpTSjYnYfAQSiz', 'Gsbw8H4LN9QSLNmB9'],
    isVisible: true,
    workflow: {
      status: 'new',
    },
  ...
  },
  {
    ...
    ancestors: ['x6EY6r4jGJga8dAKK', 'W2dPNFoM57hGFvxLm'],
    type: 'variant',
    price: 14.99,
    inventoryManagement: true,
    inventoryPolicy: true,
  ...
  },
  {
    ...
    ancestors: ['x6EY6r4jGJga8dAKK', 'fkXgNBsWeK6fM3Gjc'],
    type: 'variant',
    price: 14.99,
    inventoryManagement: true,
    inventoryPolicy: true,
